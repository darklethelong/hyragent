...
from langchain.vectorstores.milvus import Milvus # Importing Milvus vector store from Langchain
...
class MilvusConfig:
    data_path: Path
    database_path: Path = "./milvus_index"
...
class MilvusDB:
    """Vector database implementation using Milvus"""
    
    def __init__(self, config: MilvusConfig):
        """
        Initialize MilvusDB with configuration
        
        Args:
            config: MilvusConfig object containing database settings
        """
        self.config = config
    ...
    def _initialize_vectordb(self) -> Milvus:
